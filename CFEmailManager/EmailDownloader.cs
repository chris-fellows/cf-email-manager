...
namespace CFEmailManager
{
    ...
    public class EmailConnection
    {
        ...
        private void DownloadFolder(MailClient mailClient, Imap4Folder folder, string localFolder, bool downloadAttachments,
                                    ...
                                    IEmailRepository emailRepository)
        {
            ...
            {             
                ...
                foreach (var subFolder in folder.SubFolders)
                {
                    ...
                    DownloadFolder(mailClient, subFolder, localSubFolder, downloadAttachments, emailFolder, emailRepository);
        ...
        private void SetNotExistsOnServer(EmailFolder emailFolder, IEmailRepository emailRepository)
        {
        ...
        private EmailObject SaveEmail(Mail mail, string localFolder, bool downloadAttachments,
